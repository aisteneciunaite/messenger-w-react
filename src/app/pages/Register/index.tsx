    ...
    <main className="Register">
      <Form onSubmit={handleSubmit} submitButtonText="Registruotis">
        {Object.values(inputs).map(input => (
          <Field input={input} key={input.id} setError={value => setInputError(input.id, value)} />
        ))}
      </Form>
    </main>
  );
